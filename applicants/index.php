...
<?php require "../partials/_header.php"; ?>
    <title>Applicants | Placement Cell</title>
</head>
<body>
    <?php
    ...
    <main>
        ...
        <?php
        $applicants=implode(',',json_decode(mysqli_fetch_assoc(mysqli_query($conn_stu,"SELECT * FROM `company` WHERE `company_id`='{$_SESSION['company_id']}'"))['applicants_id']));
