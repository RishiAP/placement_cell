...
<nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php
          if(isset($_SESSION['admin_id']) || isset($_SESSION['company_id']) || isset($_SESSION['user_id'])){
            ...
            echo '<section class="d-flex flex-column" style="position:relative;"><li>
            <input type="search" name="main_search" id="main_search" class="plh-none w-auto form-control" placeholder="'.$placeholder.'">
          </li><ul class="list-group" id="search_results"></section>';
          }
        ?>
      </ul>
  ...
  <div id="page_main_message" class="sticky-top" style="top:70px;"></div>
  <?php
  if(isset($_SESSION['user_id']) || isset($_SESSION['admin_id']) || isset($_SESSION['company_id'])){
