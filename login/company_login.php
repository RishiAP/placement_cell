...
<body>
    ...
    <form action="" onkeydown="return event.key != 'Enter'" method="post" id="login_form" class="container">
        <select name="" id="" class="form-select mb-3" disabled>
            <option selected>Log In as Company</option>
        </select>
    <div class="input-group">
        <div class="myInputTag">Email or Company Name</div>
        <input type="text" name="username" id="username" class="form-control plh-none mb-3" placeholder="Email or Company Name">
</div>
    <div class="input-group">
